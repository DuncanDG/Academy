...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Ssapp') }} | Users</title>
        <!-- Favicon -->
                ...
                <div class="wrapper">
                        <div class="sidebar">
                                <div class="sidebar-wrapper">
                                    <div class="logo">
                                        <a href="#" class="simple-text logo-mini">{{ _('Hi') }}</a>
                ...
                <div class="">
                    <table class="table tablesorter " id="">
                        ...
                        <tbody>
                            ...
                            <tr>  
                                <td>{{$user->name}}</td>
                                <td><a href="mailto:admin@black.com">{{$user->email}}</a></td>
